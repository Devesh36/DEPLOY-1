...
export function Landing() {
  ...
  return (
    <main className="flex flex-col items-center justify-center  dark:bg-black p-4 text-white " id = "deploy">
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            }} disabled={uploadId !== "" || uploading} className="w-full border" type="submit">
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input className="text-black" id="deployed-url" readOnly type="url" value={`http://${uploadId}.localhost:3002/index.html`} />
          </div>
          <br />
          <Button className="w-full " variant="outline">
            <a href={`http://${uploadId}.localhost:3002/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
